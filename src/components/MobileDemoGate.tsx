      ...
      <div className="relative h-full">
        ...
        {device === "mobile" && force && !landscape && (
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-4 bg-white/85 backdrop-blur-sm text-center px-6">
            ...
            >
              <span className="block h-2 w-2 rounded-full bg-brand/40" />
            </span>
            <div>
        ...
        <div className="rounded-xl overflow-hidden border border-neutral-200 shadow-sm h-full">
          <iframe
            src={`${BASE}/demo/`}
            title="拍卖竞价显示系统 · 在线体验"
            className="w-full h-[calc(100dvh-13rem)] min-h-[70vh] border-0 bg-white"
            loading="lazy"
          />
        </div>
      </div>
